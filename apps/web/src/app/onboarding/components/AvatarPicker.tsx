...
export function AvatarPicker({ avatarPreview, isLoading, onAvatarChange }: AvatarPickerProps) {
  return (
    <div className="mt-6">
      ...
      <div className="mt-2 flex items-center gap-4">
        <Avatar
          ...
          size="lg"
          fallback={
            isLoading ? <Loader2 className="h-5 w-5 animate-spin text-slate-400" /> : "No image"
          }
