...
function ConversationAvatar({
  ...
  if (conversation.type === "dm") {
    ...
    if (!other) return <Avatar avatarUrl={null} name="?" />;
    return (
      <Avatar
  ...
  if (!first) return <Avatar avatarUrl={null} name="#" />;
  if (!second) return <Avatar avatarUrl={first.avatarUrl} name={first.firstName} />;
